...
================================================= */
	...
	if( have_posts() ) :	
		$layout_type = get_theme_mod( 'daze_custom_archives_layout',  false ) ?
			get_theme_mod( 'daze_archives_layout_type', 'tiny' ) :
			get_theme_mod( 'daze_blog_layout_type', 'masonry' );
		
		$layout_width = get_theme_mod( 'daze_custom_archives_layout', false ) ?
			get_theme_mod( 'daze_archives_layout_width', 'narrow' ) :
			get_theme_mod( 'daze_blog_layout_width', 'narrow' );
		
		$s = get_theme_mod( 'daze_custom_archives_layout', false ) ?
				get_theme_mod( 'daze_archives_include_sidebar', false ) :
...
?>
		<div class="archive-header-holder content-wrapper clearfix">
			<div class="archive-header post-header">
				<h1><?php esc_html_e( 'Archive', 'daze' ); ?></h1>
			</div>
		</div>
